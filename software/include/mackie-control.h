...
// Defines The message group
typedef enum {
    MSG_GROUP_VPOT_ROTATION,
    MSG_GROUP_EXTERNAL_CONTROL,
    MSG_GROUP_VPOT_LED_RING,
    MSG_GROUP_JOG_WHEEL,
    MSG_GROUP_TIMECODE_DIGIT,
    MSG_GROUP_ASSIGNMENT_DIGIT,
    MSG_GROUP_REC,
    MSG_GROUP_SOLO,
    MSG_GROUP_MUTE,
    MSG_GROUP_SELECT,
    MSG_GROUP_VPOT_SWITCH,
    MSG_GROUP_VPOT_ASSIGNMENT,
    MSG_GROUP_FADERS_BANK,
    MSG_GROUP_DISPLAY,
    MSG_GROUP_FUNCTION_SELECTION,
    MSG_GROUP_GLOBAL_VIEW,
    MSG_GROUP_MODIFIER,
    MSG_GROUP_AUTOMATION,
    MSG_GROUP_UTILITIES,
    MSG_GROUP_OTHER,
    MSG_GROUP_TRANSPORT,
    MSG_GROUP_NAVIGATION,
    MSG_GROUP_USER_SWITCH,
    MSG_GROUP_FADER_TOUCHED,
    MSG_GROUP_LED,
    MSG_GROUP_RELAY_CLICK,
    MSG_GROUP_FADER_POSITION,
    MSG_GROUP_METER,
    //
    MSG_GROUP_UNKNOWN,
} msg_group_t;
...
class MidiMcuMsg : public midi::MidiMsg {
   public:
     ...
     * \param  message  MIDI message to base
     */
    MidiMcuMsg(midi::midi_msg_t message);
    ...
    /**
     * \brief Checks if the message is a track meter value.
     * \return True if it's a track meter message, false otherwise.
     */
    bool isMeter();
    ...
    /**
     * \brief Getter for message group, indicating what kind of message is this
     * \return Enum of message group
     */
    msg_group_t getMsgGroup();
